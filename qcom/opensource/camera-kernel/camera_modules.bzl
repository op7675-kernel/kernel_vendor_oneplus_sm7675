...
def _define_module(target, variant):
    ...
    ddk_module(
        ...
        srcs = [
            ...
            "drivers/oplus/cam_sensor_module/cam_actuator/oplus_cam_actuator_core.c",
            "drivers/oplus/cam_sensor_module/cam_actuator/oplus_cam_actuator_dev.c",
            "drivers/oplus/cam_sensor_module/cam_eeprom/oplus_cam_eeprom_core.c",
            "drivers/oplus/cam_sensor_module/cam_eeprom/oplus_cam_eeprom_dev.c",
            "drivers/oplus/cam_sensor_module/cam_eeprom/oplus_cam_eeprom_soc.c",
            "drivers/oplus/cam_sensor_module/cam_eeprom/oplus_cam_insensor_eeprom_dev.c",
            ...
            "drivers/oplus/cam_sensor_module/cam_tof8801/tof8801_app0.c",
            "drivers/oplus/cam_sensor_module/cam_tof8801/tof8801_bootloader.c",
            "drivers/oplus/cam_sensor_module/cam_tof8801/tof8801_driver.c",
            "drivers/oplus/cam_sensor_module/cam_tof8801/tof8801_pdrv.c",
            "drivers/oplus/cam_sensor_module/cam_tof8801/tof_hex_interpreter.c",
            "drivers/oplus/cam_sensor_module/cam_utils/oplus_cam_kevent_fb.c",
        ],
	local_defines = [
	    "CONFIG_SPECTRA_ISP=1",
	    "CONFIG_SPECTRA_ICP=1",
	    "CONFIG_SPECTRA_JPEG=1",
	    "CONFIG_SPECTRA_CRE=1",
	    "CONFIG_SPECTRA_SENSOR=1",
	    "CONFIG_SPECTRA_LLCC_STALING=1",
	    "CONFIG_SPECTRA_USE_RPMH_DRV_API=1",
	    "CONFIG_SPECTRA_USE_CLK_CRM_API=1",
	    "CONFIG_DOMAIN_ID_SECURE_CAMERA=1",
	    "CONFIG_DYNAMIC_FD_PORT_CONFIG=1",
	    "CONFIG_SPECTRA_OPLUS=1",
	    "OPLUS_FEATURE_CAMERA_COMMON=1",
	],
        conditional_srcs = {
